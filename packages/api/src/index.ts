...
export type TournamentMatch = {
  ...
  home_slot_source: 'REGISTRATION' | 'GROUP_RANK' | 'MATCH_WINNER' | 'TEAM_PLACEHOLDER' | null;
  away_slot_source: 'REGISTRATION' | 'GROUP_RANK' | 'MATCH_WINNER' | 'TEAM_PLACEHOLDER' | null;
